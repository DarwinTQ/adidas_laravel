...
<div class="data-table">
    ...
    <div class="search-container">
        <form method="GET" action="{{ route('logistica.repartidores') }}" class="search-box" id="search-form">
            <div style="position: relative;">
                <i class="fas fa-search search-icon"></i>
                <input type="number" 
                       name="search" 
                       class="search-input" 
                       placeholder="Buscar por ID de Repartidor..." 
        ...
        @if(request('search'))
            <a href="{{ route('logistica.repartidores') }}" class="clear-btn">
